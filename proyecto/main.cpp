...
int main() {
    ...
    if (archivo.is_open()) {
        ...
        cerr << "Could not open 'likes_y_ver_mas_tarde.csv'" << endl;
    }
...
// Correr
// cd proyecto
// g++ -o programa main.cpp Objetos/Info_peli.cpp Objetos/Peliculas.cpp Objetos/UsuarioManager.cpp Objetos/Usuarios.cpp Database.cpp Funciones.cpp -I./Objetos
// ./programa